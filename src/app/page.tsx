                  ...
                  <div className="p-8">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start space-x-3">
                          <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                          <p className="text-gray-700"><strong>Manutenção e suporte:</strong> Infraestrutura tecnológica 24/7 e atualizações de segurança</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 p-6 rounded-lg mb-6 border border-blue-200">
                      <h4 className="font-bold text-blue-900 mb-3">Benefícios que você receberá:</h4>
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <p className="font-medium text-blue-800">Cartão Virtual:</p>
                          <p className="text-blue-700">• Ativação imediata</p>
                          <p className="text-blue-700">• Uso em estabelecimentos credenciados</p>
                          <p className="text-blue-700">• Consulta de saldo pelo app</p>
                        </div>
                        <div>
                          <p className="font-medium text-blue-800">Cartão Físico:</p>
                          <p className="text-blue-700">• Entrega em casa</p>
                          <p className="text-blue-700">• Chip de segurança</p>
                          <p className="text-blue-700">• Tecnologia contactless</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      <Alert className="bg-yellow-50 border-yellow-300">
                        <AlertDescription className="text-yellow-800 text-sm">
                          <strong>Transparência de Preços:</strong> A taxa de R$ 47,00 é o único custo do processo. 
                          Não há taxas ocultas, mensalidades ou custos adicionais. Este valor cobre integralmente 
                          todos os serviços descritos acima.
                        </AlertDescription>
                      </Alert>
                    </div>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <Alert className="mb-8 bg-blue-50 border-blue-300">
                <AlertDescription className="text-blue-900 text-center">
                  <strong>Taxa obrigatória</strong> conforme Lei n° 14.628/2025 para emissão dos cartões virtual e físico.
                </AlertDescription>
              </Alert>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-gray-800 rounded-lg p-4 mb-6">
            <p className="text-xs text-gray-300 leading-relaxed text-center">
              <strong>Disclaimer:</strong> Este site coleta dados pessoais (CPF, nome, e-mail) exclusivamente para 
              verificação de elegibilidade ao Programa Brasil Saudável, conforme Lei Federal n° 14.628/2025. 
              Todas as informações são protegidas por SSL e tratadas conforme LGPD. 
              O pagamento da taxa administrativa é obrigatório por lei para emissão dos cartões. 
              Não somos responsáveis por problemas técnicos de terceiros ou interrupções temporárias do serviço.
            </p>
          </div>
          ...
          <div className="bg-blue-900 rounded-lg p-4 mb-6">
            <p className="text-xs text-blue-100 leading-relaxed text-center">
              <strong>Conformidade:</strong> Este site cumpre todas as políticas do Google Ads, incluindo transparência 
              de preços, segurança de dados, proteção de informações pessoais e práticas comerciais éticas. 
              Utilizamos SSL para proteção de dados sensíveis e não coletamos informações desnecessárias. 
              Todos os custos são divulgados claramente antes do pagamento.
            </p>
          </div>
